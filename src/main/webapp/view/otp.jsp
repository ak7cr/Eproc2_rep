    ...
    <div class="card">
      <div class="icon-container">
        <div id="iconWrapper" class="icon-wrapper">
          <svg id="mailIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
          viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" 
          stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" 
          x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
          <svg id="keyIcon" class="hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
          viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" 
      ...
      <p id="subtitle">Please enter your email address to receive a verification code</p>
      ...
      <form id="otpForm" class="hidden">
        <div class="otp-container">
          ...
          <input type="text" id="otpInput" maxlength="6" class="otp-input" placeholder="Enter OTP" required>
        </div>
